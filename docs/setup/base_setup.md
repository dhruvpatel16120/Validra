...
> **Starting from scratch?** This guide walks you through installing every tool you need to start contributing to Validra with **Team VisionMinds — Think. Build. Transform.**. No prior setup assumed.
...
```mermaid
flowchart LR
    A["✅ Base Setup\n<b>COMPLETE</b>"] --> B["🎨 Frontend Setup"]
    A --> C["⚙️ Backend Setup"]
    B --> D["📐 Read Your Blueprint"]
    C --> D
    D --> E["🚀 Start Building!"]
    ...
    style D fill:#0d1117,stroke:#ffab00,color:#fff
...
|-------|---------------|:----:|
| **Frontend Setup** | Next.js project, Tailwind CSS v4, Prisma, shadcn/ui, dev server | [frontend_setup.mdx](./frontend_setup.mdx) |
| **Backend Setup** | FastAPI, virtual env, PostgreSQL connection, API development | [backend_setup.mdx](./backend_setup.mdx) |

### Architecture Blueprints

After running setup, read your team's blueprint before writing code:

| Blueprint | Owner | Link |
|-----------|-------|:----:|
| Landing Pages | FE-1 | [landing-blueprint.md](../blueprints/frontend/landing/landing-blueprint.md) |
| Inspector + Auth | FE-2 | [inspector-blueprint.md](../blueprints/frontend/inspector/inspector-blueprint.md) |
| Admin Portal | FE-3 | [admin-blueprint.md](../blueprints/frontend/admin/admin-blueprint.md) |
| Backend API | M2 | [backend-blueprint.md](../blueprints/backend/backend-blueprint.md) |
| Database Schema | All | [schema-blueprint.md](../blueprints/db/prisma/schema-blueprint.md) |
| Full System | All | [blueprint.md](../blueprint.md) |
